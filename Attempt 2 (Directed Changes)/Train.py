...
class neural_network:
	...
	def __init__(self, game, nodes = [7, 250, 250, 4], adjustment_rate = 0.000001, adjustment_rate_falloff = 1, backwards_propogation_algorithm = 1, loss_function = 1, activation_functions = [2, 2, 0], neural_network_type = 1, gamma = 0.95, gamma_increase = 1.10, gamma_max = 0.95, minibatch_minimum = 5000, minibatch_maximum = 100000, minibatch_size = 256, weight_decay_factor = 0.0001):
		# assign variables
		self.game = game
	...
	def backpropagate(self, start_state, action, reward, next_state, not_terminated, clip_max = np.inf):
